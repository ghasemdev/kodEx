...
object Badges {
    val all: List<BadgeDefinition> = listOf(
        BadgeDefinition(
            ...
            iconPath = "icons/badges/kotlin-ninja.svg",
        ),
        BadgeDefinition(
            ...
            iconPath = "icons/badges/android-architect.svg",
        ),
        BadgeDefinition(
            id = "night-owl",
            name = "Night Owl",
            ...
            iconPath = "icons/badges/night-owl.svg",
        ),
        BadgeDefinition(
            id = "steady-hand",
            name = "Steady Hand",
            ...
            iconPath = "icons/badges/steady-hand.svg",
        ),
        BadgeDefinition(
            id = "bug-hunter",
            name = "Bug Hunter",
            ...
            iconPath = "icons/badges/bug-hunter.svg",
        ),
        BadgeDefinition(
            id = "speed-demon",
            name = "Speed Demon",
            ...
            iconPath = "icons/badges/speed-demon.svg",
        ),
        BadgeDefinition(
            id = "creative-chaos",
            name = "Creative Chaos",
            ...
            iconPath = "icons/badges/creative-chaos.svg",
        ),
        BadgeDefinition(
            id = "hello-world",
            name = "Hello World",
            ...
            iconPath = "icons/badges/hello-world.svg",
        ),
    )
}
