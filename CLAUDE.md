...
specs/002-design-system/plan.md
...
Research (library versions, decisions): specs/002-design-system/research.md
Data model: specs/002-design-system/data-model.md
Quick-start: specs/002-design-system/quickstart.md
<!-- SPECKIT END -->
